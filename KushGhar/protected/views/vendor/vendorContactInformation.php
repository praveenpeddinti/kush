...
<section>
	...
	<?php echo $form->textField($model,'Email',array('value'=>$getVendorDetailsType1->email_address, 'maxLength' => 100, 'class'=>'span12', 'placeholder'=>'Email…')); ?>
    ...
    <?php echo $form->labelEx($model,'<abbr title="required">*</abbr> phone'); ?><input type="text" value="+91" disabled="disabled" class="span2"/>
        <?php echo $form->textField($model,'Phone',array('value'=>$getVendorDetailsType1->phone, 'placeholder'=>'Phone…', 'class'=>'span10', 'maxLength' => 10, 'onkeypress' => 'return isNumberKey(event);')); ?>
    ...
    <?php echo $form->labelEx($model,'<abbr title="required">*</abbr> address line1'); ?>
        <?php echo $form->textField($model,'Address1',array('value'=>$getVendorAddress->address_line1,'placeholder'=>'Address Line 1…', 'maxLength' => 100, 'class'=>'span12')); ?>
        <?php echo $form->error($model,'Address1'); ?>

   </div>
    <div class=" span6">
        <?php echo $form->labelEx($model,'address Line2'); ?>
        <?php echo $form->textField($model,'Address2',array('value'=>$getVendorAddress->address_line2,'placeholder'=>'Address Line 2…', 'maxLength' => 100, 'class'=>'span12')); ?>
   ...
   <div class="row-fluid">
    ...
    <?php echo $form->labelEx($model,'<abbr title="required">*</abbr> pin code'); ?>
        <?php echo $form->textField($model,'PinCode',array('value'=>$getVendorAddress->address_pin_code,'placeholder'=>'Pin Code…', 'class'=>'span12', 'maxLength' => 6, 'onkeypress' => 'return isNumberKey(event);')); ?>
