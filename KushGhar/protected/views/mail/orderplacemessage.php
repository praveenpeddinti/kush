                            ...
                            <td>
                                ...
                                <table width="650" cellspacing="0" cellpadding="0" border="0" align="center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($HouseService['window_grills'] == 1) echo "Window grills cleaning</br>"; 
                ...
                <table width="650" cellspacing="0" align="center" cellpadding="0" border="0" bgcolor="#fcfcfc">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td  bgcolor="#ededed" align="left" style="font-family: Helvetica, sans-serif; font-size: 11px; color: #757887; line-height: 16px;">Copyright &copy; 2014 <a href="{--SITEURL--}" target="_blank" style="text-decoration: none;"> KushGhar</a> All Rights Reserved.</td>
                        </tr>
                    </tbody>
                </table>
                <!-- END OF FOOTER TABLE -->
