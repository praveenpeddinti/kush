<?php 
 ...
 echo $rescheduleForm->hiddenField($model,'rowNo', array('value'=>$rowNo)); 
...
<script type="text/javascript">
    function reschedule(){
        if(validate()){
            ...
            data+= '&Type=' + $("#OrderRescheduleForm_ServiceType").val()+'&OrderNumber='+$("#OrderRescheduleForm_OrderNumber").val()+'&rowNo='+$("#OrderRescheduleForm_rowNo").val();
            ajaxRequest('/admin/orderStatus', data, rescheduleHandler)
    }
    }
    function validate(){
