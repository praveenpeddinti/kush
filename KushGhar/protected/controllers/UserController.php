...
class UserController extends Controller {
    ...
    public function actionLogin() {
        ...
        if (isset($_POST['LoginForm'])) {
            ...
            if ($errors != '[]') {
                ...
                if ($result == "false") {
                    $errors = array("LoginForm_error" => 'Invalid User.');
                    $obj = array('status' => '', 'data' => '', 'error' => $errors);
                } else {
    ...
    public function actionBasicinfo() {
        ...
        if ($formName != '') {
            ...
            $this->render('basicinfo', array("model" => $basicForm, "IdentityProof" => $Identity, "customerDetails" => $customerDetails, "customerAddressDetails" => $customerAddressDetails));
        }
    }
