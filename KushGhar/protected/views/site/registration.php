                        ...
                        <div class="paddinground">
                            ...
                            <fieldset>
                                ...
                                <center>
                                        ...
                                        <?php
                                        echo CHtml::ajaxButton('Submit', array('site/registration'), array(
                                            'type' => 'POST',
                                            'dataType' => 'json',
                                            'beforeSend' => 'function(){
                        ...
                        <div class="paddinground">
                            ...
                            <fieldset>
                                ...
                                <center>
                                    ...
                                    <?php echo CHtml::ajaxButton('Login', array('site/login'), array(
                                            'type' => 'POST',
                                            'dataType' => 'json',
  ...
  <div class="modal-dialog">
   ...
   <?php echo $form->error($modelSample,'Email'); ?>
                    ...
                    <div class="headerbuttonpopup" style="text-align: right">
                        ...
                        <?php echo CHtml::ajaxButton('Send',array('site/forgot'), array(
            'type' => 'POST',
            'dataType' => 'json',
