...
//            $query = "select count(*) as count from KG_vendor_individual";
    ...
    public function getAllRegisteredVendorUsers($start,$end,$uname,$location,$status){
        try{ 
            if(($uname=='')&&($location=='')&&($status=='20'))
                $query = "select i.vendor_id as vid, CONCAT_WS(' ',i.first_name,i.middle_name,i.last_name) as UserName, i.email_address, i.phone,i.create_timestamp as RegisteredOn,i.status, ad.address_city as Location from  KG_vendor_individual i join KG_vendor_address ad on ad.vendor_individual_id=i.vendor_id ORDER BY i.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname=='')&&($location=='')&&($status!='20'))
                $query="select i.vendor_id as vid, CONCAT_WS(' ',i.first_name,i.middle_name,i.last_name) as UserName, i.email_address, i.phone,i.create_timestamp as RegisteredOn,i.status, ad.address_city as Location from  KG_vendor_individual i join KG_vendor_address ad on ad.vendor_individual_id=i.vendor_id and i.status=".$status." ORDER BY i.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname!='')&&($location=='')&&($status=='20'))
                $query="select i.vendor_id as vid, CONCAT_WS(' ',i.first_name,i.middle_name,i.last_name) as UserName, i.email_address, i.phone,i.create_timestamp as RegisteredOn,i.status, ad.address_city as Location from  KG_vendor_individual i join KG_vendor_address ad on ad.vendor_individual_id=i.vendor_id and CONCAT_WS(' ',i.first_name,i.middle_name,i.last_name) like '%".$uname."%' ORDER BY i.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname=='')&&($location!='')&&($status=='20'))
                $query="select i.vendor_id as vid, CONCAT_WS(' ',i.first_name,i.middle_name,i.last_name) as UserName, i.email_address, i.phone,i.create_timestamp as RegisteredOn,i.status, ad.address_city as Location from  KG_vendor_individual i join KG_vendor_address ad on ad.vendor_individual_id=i.vendor_id and ad.address_city like '%".$location."%' ORDER BY i.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname=='')&&($location!='')&&($status!='20'))
                $query="select i.vendor_id as vid, CONCAT_WS(' ',i.first_name,i.middle_name,i.last_name) as UserName, i.email_address, i.phone,i.create_timestamp as RegisteredOn,i.status, ad.address_city as Location from  KG_vendor_individual i join KG_vendor_address ad on ad.vendor_individual_id=i.vendor_id and i.status=".$status." and ad.address_city like '%".$location."%' ORDER BY i.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname!='')&&($location=='')&&($status!='20'))
                $query="select i.vendor_id as vid, CONCAT_WS(' ',i.first_name,i.middle_name,i.last_name) as UserName, i.email_address, i.phone,i.create_timestamp as RegisteredOn,i.status, ad.address_city as Location from  KG_vendor_individual i join KG_vendor_address ad on ad.vendor_individual_id=i.vendor_id and CONCAT_WS(' ',i.first_name,i.middle_name,i.last_name) like '%".$uname."%' and i.status=".$status." ORDER BY i.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname!='')&&($location!='')&&($status=='20'))
                $query="select i.vendor_id as vid, CONCAT_WS(' ',i.first_name,i.middle_name,i.last_name) as UserName, i.email_address, i.phone,i.create_timestamp as RegisteredOn,i.status, ad.address_city as Location from  KG_vendor_individual i join KG_vendor_address ad on ad.vendor_individual_id=i.vendor_id and CONCAT_WS(' ',i.first_name,i.middle_name,i.last_name) like '%".$uname."%' and ad.address_city like '%".$location."%' ORDER BY i.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname!='')&&($location!='')&&($status!='20'))
