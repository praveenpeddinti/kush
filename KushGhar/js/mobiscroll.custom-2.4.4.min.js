...
(new Date(r,o-1,32)).getDate();if(d<=g)break;o++;d-=g}while(1)}n=new Date(r,o-1,d,-1==p?n:p&&12>n?n+12:!p&&12==n?0:n,j,v);if(n.getFullYear()!=r||n.getMonth()+1!=o||n.getDate()!=d)throw"Invalid date";return n}})(jQuery);(function(a){a.mobiscroll.themes.ios={defaults:{dateOrder:"MMdyy",rows:5,height:30,width:55,headerText:!1,showLabel:!1}}})(jQuery);
