                        ...
                        <div id="accounts" class="collapse in">
                            ...
                            <ul class="l_menu_sub_menu">
                                <li class="active"><a href="basicinfo"> <i class="fa fa-user"></i> Basic Info</a>
                                    <div class="<?php if ($customerDetails->uIdNumber == '') { echo 'status_info1';} else {echo 'status_info2';} ?>"></div>
                                </li>
                                <li ><a href="contactInfo"> <i class="fa fa-phone"></i> Contact Info</a>
                                    <div class="<?php if ($customerAddressDetails->address_city == '') {echo 'status_info1';} else {echo 'status_info2';} ?>"> </div>
                                </li>
...
//                                                          'minSizeLimit'=>10*1024,// minimum file size in bytes
                                ...
                                <div class="row-fluid paddingT10">
                                    ...
                                    <div class="span6">
                                        <?php echo $form->label($model, '<abbr title="required">*</abbr> Date of Birth'); ?>
                                        <?php echo $form->textField($model, 'dateOfBirth', array('value' => $customerDetails->birth_date, 'class' => 'span10')); ?>
