<?php if ($totalCount <= 0) { ?>
                ...
                <?php $len= strlen($row['email_address']);
                    if($len>15){echo substr($row['email_address'],0,15).'...';}else{echo $row['email_address'];}?>
            </span><div style="display:none;width:400px" id="Comments<?echo $row['cid'];?>__div" class="table_tooltip" ></div>
                                            </td>
