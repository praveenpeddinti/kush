...
<section>
    	...
    	<div class="asideBG">
            ...
            <div id="accounts" class="collapse in">
            	...
            	<ul class="l_menu_sub_menu">
                	<li><a href="basicinfo"> <i class="fa fa-user"></i> Basic Info</a> <div class="<?php if($customerDetails->uIdNumber==''){ echo 'status_info1';}else{echo 'status_info2';}?>"> </div></li>
                    <li class="active"><a href="contactInfo"> <i class="fa fa-phone"></i> Contact Info</a> <div class="<?php if($customerAddressDetails->address_city==''){ echo 'status_info1';}else{echo 'status_info2';}?>"> </div></li>
    ...
    <?php echo $form->labelEx($model,'<abbr title="required">*</abbr> phone'); ?>
        <?php echo $form->textField($model,'Phone',array('value'=>$customerDetails->phone, 'placeholder'=>'Phone Number…', 'class'=>'span12')); ?>
        <?php echo $form->error($model,'Phone'); ?>
    </div>
    <div class=" span6">
    <?php echo $form->labelEx($model,'alternate Phone'); ?>
        <?php echo $form->textField($model,'AlternatePhone',array('value'=>$customerAddressDetails->alternate_phone,'placeholder'=>'Alternative Phone Number…', 'class'=>'span12')); ?>
   ...
   <div class="row-fluid">
    ...
    <?php echo $form->labelEx($model,'<abbr title="required">*</abbr> pin code'); ?>
        <?php echo $form->textField($model,'PinCode',array('value'=>$customerAddressDetails->address_pin_code,'placeholder'=>'Pin Code…', 'class'=>'span12')); ?>
