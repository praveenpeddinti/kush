    ...
    public function getRegisteredUser($uname,$city,$location,$status){
        try{
            if(($uname=='')&&($city=='')&&($status=='20')&&($location==''))
                ...
                $query="select count(*) as count from KG_Customer c,KG_customer_address a,KG_Cities cc where c.customer_id=a.customer_id and cc.id=a.address_city and cc.CityName like '%".$city."%'";
            else if(($uname=='')&&($city!='')&&($status!='20')&&($location==''))
                $query="select count(*) as count from KG_Customer c,KG_customer_address a,KG_Cities cc where c.customer_id=a.customer_id and c.status=".$status." and cc.id=a.address_city and cc.CityName like '%".$city."%'";
            else if(($uname!='')&&($city=='')&&($status!='20')&&($location==''))
                ...
                $query="select count(*) as count from KG_Customer c,KG_customer_address a,KG_Cities cc where c.customer_id=a.customer_id and CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) like '%".$uname."%' and cc.id=a.address_city and cc.CityName like '%".$city."%'";
            else if(($uname!='')&&($city!='')&&($status!='20')&&($location==''))
                $query="select count(*) as count from KG_Customer c,KG_customer_address a,KG_Cities cc where c.customer_id=a.customer_id and CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) like '%".$uname."%' and cc.id=a.address_city and cc.CityName like '%".$city."%' and c.status=".$status;
           else if(($uname=='')&&($city=='')&&($status=='20')&&($location!=''))
                ...
                $query="select count(*) as count from KG_Customer c,KG_customer_address a,KG_Cities cc where c.customer_id=a.customer_id and cc.id=a.address_city and cc.CityName like '%".$city."%' and a.address_notes like '%".$location."%'";
           else if(($uname=='')&&($city=='')&&($status!='20')&&($location!=''))
                ...
                $query="select count(*) as count from KG_Customer c,KG_customer_address a,KG_Cities cc where c.customer_id=a.customer_id and cc.id=a.address_city and cc.CityName like '%".$city."%' and c.status=".$status." and a.address_notes like '%".$location."%'";
           else if(($uname!='')&&($city!='')&&($status=='20')&&($location!=''))
                $query="select count(*) as count from KG_Customer c,KG_customer_address a,KG_Cities cc where c.customer_id=a.customer_id and CONCAT_WS(' ',first_name,middle_name,last_name) like '%".$uname."%' and cc.id=a.address_city and cc.CityName like '%".$city."%' and a.address_notes like '%".$location."%'";
           else if(($uname!='')&&($city!='')&&($status!='20')&&($location!=''))
                $query="select count(*) as count from KG_Customer c,KG_customer_address a,KG_Cities cc where c.customer_id=a.customer_id and CONCAT_WS(' ',first_name,middle_name,last_name) like '%".$uname."%' and cc.id=a.address_city and cc.CityName like '%".$city."%' and c.status=".$status." and a.address_notes like '%".$location."%'"; 
           $result = Yii::app()->db->createCommand($query)->queryRow();
        }catch(Exception $ex){
    ...
    public function getAllRegisteredUsers($start,$end,$uname,$city,$location,$status){
        try{  
            if(($uname=='')&&($location=='')&&($status=='20')&&($city==''))
                $query = "select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id join KG_Cities cc on cc.id=ca.address_city ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname=='')&&($city=='')&&($status!='20')&&($location==''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id and c.status=".$status." join KG_Cities cc on cc.id=ca.address_city ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname!='')&&($city=='')&&($status=='20')&&($location==''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id and CONCAT_WS(' ',first_name,middle_name,last_name) like '%".$uname."%' join KG_Cities cc on cc.id=ca.address_city ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname=='')&&($city!='')&&($status=='20')&&($location==''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id join KG_Cities cc on cc.id=ca.address_city and cc.CityName like '%".$city."%' ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname=='')&&($city!='')&&($status!='20')&&($location==''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id and c.status=".$status." join KG_Cities cc on cc.id=ca.address_city and cc.CityName like '%".$city."%' ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname!='')&&($city=='')&&($status!='20')&&($location==''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id and CONCAT_WS(' ',first_name,middle_name,last_name) like '%".$uname."%' and c.status=".$status." join KG_Cities cc on cc.id=ca.address_city ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname!='')&&($city!='')&&($status=='20')&&($location==''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id and CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) like '%".$uname."%' and ca.address_city like '%".$city."%' join KG_Cities cc on cc.id=ca.address_city ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname!='')&&($city!='')&&($status!='20')&&($location==''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id and CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) like '%".$uname."%' and c.status=".$status." join KG_Cities cc on cc.id=ca.address_city and cc.CityName like '%".$city."%' ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname=='')&&($city=='')&&($status=='20')&&($location!=''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id and ca.address_notes like '%".$location."%' join KG_Cities cc on cc.id=ca.address_city ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname!='')&&($city=='')&&($status=='20')&&($location!=''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id and CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) like '%".$uname."%' and ca.address_notes like '%".$location."%' join KG_Cities cc on cc.id=ca.address_city ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname=='')&&($city!='')&&($status=='20')&&($location!=''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id and ca.address_notes like '%".$location."%' join KG_Cities cc on cc.id=ca.address_city and cc.CityName like '%".$city."%' ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname=='')&&($city=='')&&($status!='20')&&($location!=''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id and c.status=".$status." and ca.address_notes like '%".$location."%' join KG_Cities cc on cc.id=ca.address_city ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname!='')&&($city=='')&&($status!='20')&&($location!=''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id and CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) like '%".$uname."%' and c.status=".$status." and ca.address_notes like '%".$location."%' join KG_Cities cc on cc.id=ca.address_city ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname=='')&&($city!='')&&($status!='20')&&($location!=''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id and c.status=".$status." and ca.address_notes like '%".$location."%' join KG_Cities cc on cc.id=ca.address_city and cc.CityName like '%".$city."%' ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname!='')&&($city!='')&&($status=='20')&&($location!=''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id and CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) like '%".$uname."%' and ca.address_notes like '%".$location."%' join KG_Cities cc on cc.id=ca.address_city and cc.CityName like '%".$city."%' ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            else if(($uname!='')&&($city!='')&&($status!='20')&&($location!=''))
                $query="select c.customer_id as cid, CONCAT_WS(' ',first_name,middle_name,last_name) as UserName , c.email_address , c.phone , c.create_timestamp , ca.address_notes as Location , cc.CityName as City, c.status  from KG_Customer c join KG_customer_address ca on ca.customer_id=c.customer_id and CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) like '%".$uname."%' and ca.address_notes like '%".$location."%' and c.status=".$status." join KG_Cities cc on cc.id=ca.address_city and cc.CityName like '%".$city."%' ORDER BY c.create_timestamp DESC limit ".$start. ",".$end;
            $result = Yii::app()->db->createCommand($query)->queryAll();
        }catch(Exception $ex){
