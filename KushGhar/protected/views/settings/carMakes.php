        ...
        <div class="container minHeight">
            ...
            <article>
                <div class="row-fluid" style="height:480px">
                    <div class="span12">
                        <h4 class="paddingL20">Car Makes</h4><hr>
                        ...
                        <div class="paddinground">    
                            ...
                            <div id="tablewidget"  style="margin: auto;"><div id="message" style="display:none"></div>
                                <input type="button" id="btnNewMake" class="btn btn-primary" value="New Make" onclick="newMake()"/>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h3 id="myModalLabel">Edit Make</h3>
                            </div>
                ...
                <div id="myModalforgot" class="modal fade" >
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                <h3 id="myModalLabel">New Make</h3>
                            </div>
...
function statusChange(rowNos, status) {
        ...
        if (r == true) {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'json',
                url: '<?php echo Yii::app()->createAbsoluteUrl("/settings/changeMakeStatus"); ?>',
                data: data,
                success: function(data) {
                    activeFormHandler(data, status, rowNos);
                    getCollectionDataWithPagination('/settings/newCarMakes','userDetails', 'abusedWords_tbody',pageno,5, '');
                },
...
//            alert("else part");
    ...
    $(function(){
        getCollectionDataWithPagination('/settings/newCarMakes','userDetails', 'abusedWords_tbody',1,5,'');
    });
    ...
    function viewModel(id){
        window.location.href = '<?php echo Yii::app()->request->baseUrl; ?>/settings/carModels?MakeId='+id;
    }
    function newMake(){
        $.ajax({
                dataType: 'json',
