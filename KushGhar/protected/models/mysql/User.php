    ...
    public function saveModel($model) {
        ...
        if (!isset($user)) {
            try {
                ...
                $user->FirstName = stripcslashes($model->firstName);
                $user->LastName = stripcslashes($model->lastName);
                $user->Email = stripcslashes($model->email);
            ...
            if ($user->update())
                $result = "updated";
//            Employee::model()->updateEmployeeUserId($model, $user->UserId);
            error_log("====Employee==========");
        }
        return $result;
    }
