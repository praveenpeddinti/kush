                    ...
                    <div class="sub_menu ">
                        <div id="accounts" class="collapse in">
                            ...
                            <ul class="l_menu_sub_menu">
                                ...
                                <li  class="active"><a href="/admin/manage"> <i class="fa fa-users"></i> Invite Management</a>
                        ...
                        <div class="paddinground">    
                            ...
                            <div id="tablewidget"  style="margin: auto;"><div id="message" style="display:none"></div>
                                <table id="userTable" class="table table-hover">
                                    ...
                                    <thead><tr><th>Name</th><th>Email Address</th><th>Phone</th><th>Location</th><th>InvitedDate</th><th>Status</th><th>Actions</th></tr></thead>
