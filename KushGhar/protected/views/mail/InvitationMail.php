                                    ...
                                    <td width="630" valign="top" align="left" style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; line-height: 18px;">
                                       <p style="font-size:14px;line-height:1.7;color:#666;font-weight:bold">Hi, </p>  
                                        <p style="font-size:14px;line-height:1.7;">
                                            KushGhar has added service in your area and we are very pleased to welcome you to the KushGhar family.
                                        </p>
                                        <p style="font-size:14px;line-height:1.7;">
                                            Please click on the following link and it will take you to our registration page.
                                        </p>
                                        <p style="font-size:14px;line-height:1.7;"><a href="<?php echo $Message;?>" target="_blank">Click here to get into Kushghar</a></p>
                                        <p style="font-size:14px;line-height:1.7;color:#666;"> KushGhar - Making people's lives better, one home at a time.</p>

                                        <span style="font-size:14px;line-height:1.7;color:#666;"> 
                                            <ul>
