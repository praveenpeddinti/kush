...
<?php } else {
    foreach ($userDetails as $row) {
        ...
        echo $status;
        ?></td>
        <td><?php $datee = explode(" ", $row['service_date']);
        echo $datee[0]; ?>
        </td>
        ...
        <td nowrap>
            ...
            <?php if ($row['status'] == 0) { ?>
                <select class="span12 action" onchange="orderAction(<?php echo $row['order_number']; ?>,<?php echo $row['id']; ?>,<?php echo $row['status']; ?>, this);">
